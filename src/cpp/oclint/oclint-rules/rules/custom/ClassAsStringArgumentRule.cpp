...
class ClassAsStringArgumentRule : public AbstractASTVisitorRule<ClassAsStringArgumentRule>
{
public:
    virtual const string name() const override
    {
        return "class as string argument";
    }
...
static RuleSet rules(new ClassAsStringArgumentRule());
