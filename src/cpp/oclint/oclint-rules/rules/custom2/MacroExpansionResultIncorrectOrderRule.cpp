...
class MacroExpansionResultIncorrectOrderRule : public AbstractASTVisitorRule<MacroExpansionResultIncorrectOrderRule>
{
public:
    virtual const string name() const override
    {
        return "macro expansion result incorrect order";
    }
...
static RuleSet rules(new MacroExpansionResultIncorrectOrderRule());
