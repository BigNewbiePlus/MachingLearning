...
class VariableIsAssignedToItselfRule : public AbstractASTVisitorRule<VariableIsAssignedToItselfRule>
{
public:
    virtual const string name() const override
    {
        return "variable is assigned to itself";
    }
...
static RuleSet rules(new VariableIsAssignedToItselfRule()); 
