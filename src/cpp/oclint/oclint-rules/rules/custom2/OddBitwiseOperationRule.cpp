...
class OddBitwiseOperationRule : public AbstractASTVisitorRule<OddBitwiseOperationRule>
{
public:
    virtual const string name() const override
    {
        return "odd bitwise operation";
    }
...
static RuleSet rules(new OddBitwiseOperationRule());
