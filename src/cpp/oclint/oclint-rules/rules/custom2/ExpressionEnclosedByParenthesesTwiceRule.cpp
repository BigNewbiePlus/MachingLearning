...
class ExpressionEnclosedByParenthesesTwiceRule : public AbstractASTVisitorRule<ExpressionEnclosedByParenthesesTwiceRule>
{
public:
    virtual const string name() const override
    {
        return "expression enclosed by parentheses twice";
    }
...
static RuleSet rules(new ExpressionEnclosedByParenthesesTwiceRule());
