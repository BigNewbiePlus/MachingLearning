...
class ArgumentOfSizeofIsNumberRule : public AbstractASTVisitorRule<ArgumentOfSizeofIsNumberRule>
{
public:
    virtual const string name() const override
    {
        return "argument of sizeof is number";
    }
...
static RuleSet rules(new ArgumentOfSizeofIsNumberRule());
