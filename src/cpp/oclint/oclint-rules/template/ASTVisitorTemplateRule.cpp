...
class ASTVisitorTemplateRule : public AbstractASTVisitorRule<ASTVisitorTemplateRule>
{
public:
    virtual const string name() const override
    {
        return "ast visitor template";
    }
...
static RuleSet rules(new ASTVisitorTemplateRule());
